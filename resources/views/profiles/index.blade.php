       ...
       <div class="col-sm-9">
           <div class="d-flex pb-2">
               ...
               @can('update', $user->profile)
                    <a class="btn btn-secondary btn-sm" href=" {{url('/profile/'.$user->id.'/edit')}}">Edit Profile</a>
               @endcan  
           </div>
           ...
           @can('update', $user->profile)
            <div class="float-right">
                <a class="btn btn-primary btn-sm" href="{{url('/p/create')}}">Add new post</a>
            </div>   
           @endcan
   ...
   <div class="row pt-3" style="background: rgb(255 255 255 / 54%);padding: 12px;border-radius: 5px;">
    ...
    <div class="col-sm-4" style="padding:1px">
        <a href="{{url('/p/'. $post->id) }}">
            <img src="{{url('/images/'.$post->image)}}" class="w-100">
        </a>
